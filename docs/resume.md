...
- :simple-anthropic: Claude/Anthropic API
- :fontawesome-brands-openai: ChatGPT/Codex
- :material-cursor-default: Cursor
- :octicons-copilot-16: Copilot
- :material-hub: MCPs
- :material-chart-timeline-variant: Agentic Workflow Design
- :material-puzzle: Agent Skills Architecture
- :material-brain: LLM Integration
...
- :simple-git: Git
- :material-book-open-variant: Knowledge Management
...
:material-circle-medium: Lead a 2-person team through an internal onboarding overhaul across 11+ Engineering departments, delivering a documentation standard designed for fast orientation, minimal upkeep, and machine indexing across every department space.

:material-circle-medium: Built and maintained a Claude Code skill library at CoreWeave covering internal documentation authoring, workspace health auditing, and process workflow automation, as well as a chat-based conversational agent to surface the same auditing and writing capability for company-wide, non-technical use.

:material-circle-medium: Ran CoreWeave's Lunch & Learn educational programming, doubling cadence to twice monthly. Partnered with DevEx and internal AI champions to launch a supplementary AI skills series that drew 300+ attendees per session, expanding into vendor sessions with Cursor and OpenAI, including a hosted in-person event in NYC.

:material-circle-medium: Designed, wrote, and launched CoreWeave's AI developer tools hub from the ground up, transforming an inaccurate and out-of-date reference into a repository of living resources with hundreds of weekly views.
</div>

### Camunda

<span class="bump"><strong>Technical Writer, Self-Managed</strong> (<em>May 2024 - May 2025</em>)</span>

<div class="indent" markdown>
:material-circle-medium: Led technical documentation strategy for the Self-Managed product pillar, embedding with multiple infrastructure engineering teams to design new product user journeys and improve content accuracy across documentation sets

:material-circle-medium: Instituted recurring documentation team operations, including capacity planning, issue triage workflows, and knowledge-sharing sessions, to bring structure to previously ad hoc processes

:material-circle-medium: Maintained content quality standards through peer review and style guide enforcement, managing contributions from both internal and external contributors while ensuring consistent voice across product documentation
